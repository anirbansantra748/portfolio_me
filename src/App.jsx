  ...
  projects: [
    {
      ...
      image: "/peer2.png",
      links: { 
        live: "https://peer-uii.onrender.com/", 
        github: "https://github.com/anirbansantra748/peer" 
      }
    },
    {
      title: "InterViewX",
      ...
      links: { 
        live: "https://interviewx-dgsc.onrender.com/home", 
    ...
    },
    {
      ...
      image: "/helthyfy.png",
      links: { 
        live: "https://hailthyfy-4.onrender.com/", 
        github: "https://github.com/anirbansantra748/hailthyfy" 
      }
    },
    {
      title: "Wonderlust",
      ...
      links: { 
        live: "https://wanderlust-kpw6.onrender.com/listings", 
        github: "https://github.com/anirbansantra748/Wonderlust" 
      }
    },
    {
      title: "SkillIssu",
      category: "Education • 2024",
      desc: "Skill assessment platform with coding challenges, automated testing, and progress tracking for developers.",
      stats: ["Auto Testing", "Progress Tracking", "Challenges"],
      stack: ["React", "Node.js", "MongoDB", "Express"],
      status: "Live",
      image: "/bookify.png",
      links: { 
        live: "https://skillissu-11a3.onrender.com/home", 
        github: "https://github.com/anirbansantra748/SkillIssu" 
      }
    },
    {
      title: "Game of Life",
      ...
      links: { 
        live: "https://anirbansantra748.github.io/gameOfLife/", 
        github: "https://github.com/anirbansantra748/gameOfLife" 
      }
    },
    {
      title: "NightSky",
      category: "Astronomy • 2024",
      desc: "Astronomy application with star mapping, celestial event tracking, and educational content about the universe.",
      stats: ["Star Map", "Celestial Events", "Educational"],
      stack: ["Three.js", "WebGL", "Node.js"],
      status: "Live",
      image: "/nightsky.png",
      links: { 
        live: "https://nightsky-dvhx.onrender.com/home", 
        github: "https://github.com/anirbansantra748/NightSky" 
      }
    },
    {
      title: "Mini CRM",
      category: "Business • 2024",
      desc: "Customer Relationship Management system with contact management, deal tracking, and analytics dashboard.",
      stats: ["Contact Management", "Deal Tracking", "Analytics"],
      stack: ["React", "Express", "MongoDB"],
      status: "Live",
      image: "/minicrm.png",
      links: { 
        live: "https://mini-crm-1-85lu.onrender.com", 
        github: "https://github.com/anirbansantra748/mini-crm" 
      }
    }
  ],
  openSource: [
    ...
    },
    {
      ...
      github: "https://github.com/anirbansantra748/TicketBookingSystem"
    },
    {
      name: "chess_game",
      type: "Gaming",
      ...
      github: "https://github.com/anirbansantra748/chess_game"
    },
    {
      name: "SkillIssu",
      type: "Education",
    ...
    },
    {
      ...
      github: "https://github.com/anirbansantra748/VideoTube"
    },
    {
      name: "Re_Pharma",
      type: "Healthcare",
      ...
      github: "https://github.com/anirbansantra748/Re_Pharma"
    },
    {
      name: "NightSky",
      type: "Education",
    ...
    },
    {
      ...
      github: "https://github.com/anirbansantra748/KitabiKira"
    }
  ],
  architecture: {
    hld: [
    ...
    lld: [
      { 
        ...
        image: "/ticket_booking_lld.png"
      },
      { 
        title: "Food Delivery", 
        type: "Java", 
        tags: ["Strategy Pattern", "State Machine"],
        image: "/food_delivery_lld.png"
      },
      { 
        title: "Ride Booking", 
        type: "Java", 
        tags: ["Geospatial", "Pricing Engine", "CAP Theorem"],
        image: "/ride_booking_lld.png"
      }
    ]
  },
  achievements: [
    { 
      title: "Winner - EduSands Hacks Hackathon", 
      issuer: "EduSands (Devpost)", 
      date: "2024",
      desc: "Won 1st place among 50+ teams for building InclusiveHorizon, an innovative educational platform promoting accessibility and inclusion.",
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a 
                ...
                className="px-8 py-3 bg-white/5 border border-white/10 hover:border-emerald-500 text-white rounded-lg transition-all font-medium flex items-center gap-2"
              >
                <Download size={20} />
                Download Resume
              </a>
          ...
          <div className="relative">
            ...
            <div className="relative bg-[#0d1117] border border-gray-800 rounded-xl overflow-hidden shadow-2xl">
              ...
              <div className="p-6 h-[500px] overflow-y-auto overflow-x-hidden custom-scrollbar">
            ...
            {/* Floating Badges */}
            <div className="absolute -right-4 -bottom-6 bg-[#161b22] p-4 rounded-lg border border-gray-800 shadow-xl hidden sm:block">
  ...
  return (
    <section className="py-24 bg-[#0a0a0a] border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-white mb-4">
            Coding <span className="text-emerald-400">Activity</span>
          </h2>
          <p className="text-gray-400 font-mono text-sm">
            &gt; LIVE DATA FROM GITHUB & LEETCODE...
          </p>
        </div>

        <div className="grid lg:grid-cols-2 gap-8">
          {/* GitHub Stats Card */}
          <div className="bg-[#0d1117] border border-gray-800 rounded-xl p-6 hover:border-emerald-500/30 transition-all duration-300">
            <div className="flex items-center gap-2 mb-4">
              <Github className="text-emerald-400" size={24} />
              <h3 className="text-xl font-bold text-white">GitHub Statistics</h3>
            </div>
            <img
              src="https://github-readme-stats.vercel.app/api?username=anirbansantra748&show_icons=true&theme=dark&hide_border=true&bg_color=0d1117&title_color=10b981&icon_color=10b981&text_color=ffffff"
              alt="GitHub Stats"
          ...
          <div className="bg-[#0d1117] border border-gray-800 rounded-xl p-6 hover:border-emerald-500/30 transition-all duration-300">
            ...
            <img
              src="https://leetcard.jacoblin.cool/Anirbansantra?theme=dark&font=Noto%20Sans&ext=heatmap"
              alt="LeetCode Stats"
              className="w-full rounded-lg"
              loading="lazy"
            />
        ...
        <div className="mt-8 bg-[#0d1117] border border-gray-800 rounded-xl p-6 hover:border-emerald-500/30 transition-all duration-300">
          <div className="flex items-center gap-2 mb-4">
            <GitBranch className="text-emerald-400" size={24} />
            <h3 className="text-xl font-bold text-white">Contribution History</h3>
          </div>
          <img
            src="https://ghchart.rshah.org/10b981/anirbansantra748"
        ...
        <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="bg-[#0d1117] border border-gray-800 rounded-xl p-4 text-center hover:border-emerald-500/30 transition-all duration-300">
  ...
  >
    ...
    <div className="h-48 bg-gray-900 relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4">
        <span className="px-2 py-1 bg-black/70 backdrop-blur-md border border-white/10 rounded text-[10px] font-mono text-emerald-400 flex items-center gap-1">
    ...
    <div className="p-6 flex-1 flex flex-col bg-[#121212]">
      ...
      {/* Stats Grid */}
      <div className="grid grid-cols-3 gap-2 mb-6 bg-[#0a0a0a] rounded-lg p-3 border border-white/5">
      ...
      <div className="flex flex-wrap gap-2 mb-6 mt-auto">
        {project.stack.map((tech) => (
          <span key={tech} className="px-2 py-1 bg-white/5 hover:bg-white/10 border border-white/10 rounded-md text-xs text-gray-400 font-mono transition-all">
            {tech}
          </span>
        ))}
      </div>
      ...
      <div className="flex items-center gap-3 pt-5 border-t border-white/5 mt-auto">
        <a href={project.links.live} target="_blank" rel="noopener noreferrer" className="flex-1 py-3 bg-white text-black font-bold text-sm rounded-lg hover:bg-emerald-400 transition-all flex items-center justify-center gap-2">
          Live Demo <ExternalLink size={16} />
        </a>
        <a href={project.links.github} target="_blank" rel="noopener noreferrer" className="px-4 py-3 bg-transparent border border-gray-700 text-white rounded-lg hover:border-white transition-all flex items-center justify-center">
          <Github size={20} />
        </a>
      </div>
    </div>
          ...
          <div className="bg-[#0a0a0a] border border-gray-800 rounded-xl h-full relative overflow-hidden flex flex-col shadow-2xl group">
             ...
             <div className="relative w-full h-full bg-gray-900 flex items-center justify-center overflow-hidden">
                ...
                <img 
                  ...
                  className={`w-full h-full object-contain transition-all duration-700 ${loading ? 'opacity-0 scale-105 blur-lg' : 'opacity-90 scale-100 blur-0'} group-hover:opacity-100`}
                />
                ...
                <div className="absolute bottom-6 right-6 z-20">
                   <button 
                     ...
                     className="p-2 bg-black/70 backdrop-blur-md border border-white/10 rounded-lg text-white hover:bg-emerald-500 hover:text-black transition-colors"
                   >
                      <Maximize2 size={18}/>
                   </button>
                </div>
  ...
  return (
    <section className="py-24 bg-black relative overflow-hidden">
                   ...
                   <div className="transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                      ...
                      <div className="h-0 group-hover:h-auto overflow-hidden opacity-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                         ...
                         <button 
                           ...
                           className={`w-full py-2 rounded border ${theme.border} ${theme.badge} ${theme.text} text-xs font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors flex items-center justify-center gap-2`}
                         >
      ...
      {selectedCert && (
        ...
        >
          <div className="relative max-w-5xl w-full max-h-[90vh] overflow-auto bg-[#111] rounded-xl border border-white/10 shadow-2xl">
            <button
              onClick={() => setSelectedCert(null)}
              className="absolute top-4 right-4 z-10 p-2 bg-black/80 hover:bg-white/10 border border-white/20 rounded-lg transition-colors"
            >
            ...
            <div className="p-4">
              <div className="mb-4 text-center">
                ...
                <p className="text-sm text-gray-400">{selectedCert.issuer} • {selectedCert.date}</p>
              </div>
  ...
  <footer className="bg-black border-t border-white/10 py-12">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
      ...
      <div className="flex gap-6">
        ...
        <a href="https://www.linkedin.com/in/anirban-santra-333074239/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors"><Linkedin size={20} /></a>
        <a href="https://leetcode.com/u/Anirbansantra/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-400 transition-colors" title="LeetCode"><Code size={20} /></a>
...
export default function App() {
  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen text-gray-300 font-sans selection:bg-emerald-500/30">
      {/* SEO Meta Tags */}
      <Helmet>
        <title>Anirban Santra - Full Stack Software Engineer | Backend Specialist</title>
        <meta name="description" content="Full Stack Software Engineer with 1+ years experience specializing in Node.js, microservices, and distributed systems. Building scalable platforms with React, MongoDB, Redis, and Kafka." />
        <meta name="keywords" content="Full Stack Developer, Backend Engineer, Node.js, React, Microservices, Distributed Systems, System Design, LeetCode, Kolkata, Software Engineer, India" />
        <meta name="author" content="Anirban Santra" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://portfolio-me-w31y.vercel.app/" />
        <meta property="og:title" content="Anirban Santra - Full Stack Software Engineer" />
        <meta property="og:description" content="Backend-focused engineer skilled in Node.js, Java, and distributed system design. 400+ LeetCode problems solved." />
        <meta property="og:image" content="https://portfolio-me-w31y.vercel.app/og-image.png" />
        
        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://portfolio-me-w31y.vercel.app/" />
        <meta property="twitter:title" content="Anirban Santra - Full Stack Engineer" />
        <meta property="twitter:description" content="Backend-focused engineer building scalable systems with Node.js, React, and microservices architecture." />
        <meta property="twitter:image" content="https://portfolio-me-w31y.vercel.app/og-image.png" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <meta name="language" content="English" />
        <meta name="revisit-after" content="7 days" />
        <link rel="canonical" content="https://portfolio-me-w31y.vercel.app/" />
      </Helmet>
          ...
          <div className="max-w-3xl mx-auto px-4 relative z-10">
             <div className="bg-[#111] border border-gray-800 rounded-2xl p-8 sm:p-12 shadow-2xl">
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-8">
                   ...
                   <a href="https://www.linkedin.com/in/anirban-santra-333074239/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-gray-800 p-4 rounded-xl transition-all group">
